(function (root, factory) {
    ...
    function loadWasmModule() {
        ...
        if (typeof require === 'function') {
            return Promise.resolve(require('./argon2d.js'));
        }
        return import('./argon2d.js');
    }
    ...
    function loadWasmBinary() {
        ...
        if (typeof require === 'function') {
            return Promise.resolve(require('/argon2/argon2.wasm')).then(
                (wasmModule) => {
                    return decodeWasmBinary(wasmModule);
                }
            );
        }
        const wasmPath = '/argon2/argon2.wasm';
